  ...
  return (
    <div className="recurrence-viewer">
      <div className="viewer-header">
        <h3 className="viewer-title">Recurrence Heatmap Viewer</h3>
      ...
      <div className="recurrence-content">
        ...
        {DENSITY_COLOR_SCHEMES[colorScheme] && Array.isArray(DENSITY_COLOR_SCHEMES[colorScheme]) && (channelX && channelY) && heatmapData && (
          <div className="recurrence-legend">
            <h5 className="legend-title">🔥 Density Legend (Points per Grid Cell)</h5>
            ...
            <div className="legend-info">
              <p className="legend-description">
                <strong>What is density?</strong> Each square represents a region in the 2D space formed by the two selected ECG channels.
