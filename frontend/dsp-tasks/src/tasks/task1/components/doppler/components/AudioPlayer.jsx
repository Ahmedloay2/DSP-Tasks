                        ...
                        {isGeneratedAudio ? (
                            <>
                                ...
                                {metadata.normalDistance && (
                                    <div className="metadata-item">
                                        <span className="metadata-label">Normal Distance:</span>
                                        <span className="metadata-value">{metadata.normalDistance} m</span>
                                    </div>
                                )}
                                {metadata.totalDuration && (
                                    <div className="metadata-item">
                                        <span className="metadata-label">Total Duration:</span>
                                        <span className="metadata-value">{metadata.totalDuration}s</span>
                                    </div>
                                )}
