...
export default function EEGFileUploader({ 
    ...
    return (
        <div className="task1-eeg-upload-section">
            <form className='task1-eeg-form' onSubmit={handleSubmit}>
                <div className='task1-eeg-inputs-container'>
                    {/* EDF File Input */}
                    <div className='task1-eeg-input-group'>
                        ...
                        {files.edf && (
                            <div className="file-selected">
                                <span className="file-name">{files.edf.name}</span>
                    ...
                    <div className='task1-eeg-input-group'>
                        ...
                        {files.set && (
                            <div className="file-selected">
                                <span className="file-name">{files.set.name}</span>
                                <span className="file-size">
                ...
                {/* Submit Button */}
                <button
                    className={`task1-eeg-submit-btn ${uploadStatus}`}
                    type='submit'
