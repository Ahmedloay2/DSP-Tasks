...
import EEGClassificationService from '../../services/EEGClassificationService';
  ...
  const fetchClassification = async () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        const parsedData = EEGClassificationService.parseClassificationString(result.data);
    ...
    <div className="detection-results-container">
      ...
      {loading && (
        <div className="detection-loading">
          ...
          <p className="loading-text">Analyzing EEG signal...</p>
        </div>
      )}
