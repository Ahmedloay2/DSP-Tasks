...
/**
 * SamplingViewer Component for EEG
 * 
 * Displays EEG signal with the selected sampling frequency
 * Shows play/pause controls and channel visibility toggle
 */
export default function SamplingViewer({ data, samplingFreq, title = 'EEG Signal Viewer' }) {
