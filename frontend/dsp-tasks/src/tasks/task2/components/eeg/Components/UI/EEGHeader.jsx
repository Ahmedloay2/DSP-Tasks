...
export default function EEGHeader({ 
    ...
    return (
        <>
            ...
            <div className='task2-eeg-header-wrapper'>
                <div className='task2-eeg-header-content'>
                    <h1 className='task2-eeg-header-title'>Multi-Channel EEG Signal Viewer</h1>
                    <p className='task2-eeg-header-description'>
                    ...
                    <div className='task2-eeg-header-features'>
