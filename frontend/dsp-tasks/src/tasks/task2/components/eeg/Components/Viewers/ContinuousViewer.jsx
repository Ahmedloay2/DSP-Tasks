 ...
 * Data scrolls RIGHT TO LEFT like traditional EEG monitors
 */
const ContinuousViewer = ({
  ...
  const draw = useCallback(() => {
    ...
    if (selectedChannelIds.length === 0) {
      ...
      ctx.fillText('Select channels to view continuous EEG', width / 2, height / 2);
      return;
    }
  ...
  return (
    <div className="task2-continuous-viewer" style={{ backgroundColor: '#1a1a1a' }}>
      <div className="task2-viewer-header" style={{ backgroundColor: 'transparent', borderBottom: '1px solid #444' }}>
        <h3 className="task2-viewer-title" style={{ color: '#fff' }}>Real-Time EEG Monitor</h3>
