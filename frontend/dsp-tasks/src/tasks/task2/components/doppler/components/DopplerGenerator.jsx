...
const DopplerGenerator = ({ onAudioGenerated, isLoading, setIsLoading, setError }) => {
    ...
    const handleGenerate = async () => {
        ...
        try {
            const { RealDopplerService } = await import('../services/RealDopplerService');
            const result = await RealDopplerService.generateDopplerSound(parameters);
    ...
    return (
        <div className="task2-doppler-generator">
            <div className="task2-generator-header">
                <h3>🎵 Generate Doppler Shifted Sound</h3>
                <p>Create audio demonstrating the Doppler effect with custom parameters</p>
            </div>

            <div className="task2-generator-content">
            

                {/* Parameters Section */}
                <div className="task2-parameters-section">
                    <h4>Audio Parameters</h4>
                    <div className="task2-parameters-grid">
                        {/* Source Frequency */}
                        <div className="task2-parameter-group">
                            <label htmlFor="sourceFreq">
                                ...
                                Source Frequency (f): <span className="task2-param-value">{parameters.source_freq} Hz</span>
                            </label>
                            <input
                                id="sourceFreq"
                                type="range"
                            ...
                            <input
                                ...
                                onChange={(e) => handleParameterChange('source_freq', e.target.value)}
                                disabled={isLoading}
                                className="task2-numeric-input"
                            />
                            <span className="task2-parameter-hint">Range: 100-2000 Hz (musical notes to sirens)</span>
                        </div>
                        ...
                        <div className="task2-parameter-group">
                            <label htmlFor="sourceVel">
                                ...
                                Source Velocity (v): <span className="task2-param-value">{parameters.source_velocity} m/s</span>
                            </label>
                            <input
                                id="sourceVel"
                                type="range"
                            ...
                            <input
                                ...
                                className="task2-numeric-input"
                            />
                            <span className="task2-parameter-hint">Speed of sound source (0-100 m/s)</span>
                        </div>
                        ...
                        <div className="task2-parameter-group">
                            <label htmlFor="normalDist">
                                ...
                                Normal Distance: <span className="task2-param-value">{parameters.normal_distance} m</span>
                            </label>
                            <input
                                id="normalDist"
                                type="number"
                                ...
                                className="task2-numeric-input"
                            />
                            <span className="task2-parameter-hint">Closest distance to observer (default: 10 meter)</span>
                        </div>
                        ...
                        <div className="task2-parameter-group">
                            <label htmlFor="duration">
                                ...
                                Simulation Duration: <span className="task2-param-value">{parameters.half_simulation_duration} s</span>
                            </label>
                            <input
                                id="duration"
                                type="number"
                                ...
                                className="task2-numeric-input"
                            />
                            <span className="task2-parameter-hint">Half duration (total = 2× this value, default: 3 seconds)</span>
                        </div>

                        <div className="task2-parameter-group task2-generate-section">
                            <button
                                className="task2-generate-btn"
                ...
                {/* Physics Info */}
                <div className="task2-physics-info">
                    <h4>📚 Doppler Effect Principle</h4>
                    <div className="task2-formula-section">
                        <div className="task2-formula">
                            f' = f × (c) / (c ± v)
                        </div>
                        <div className="task2-formula-legend">
                        ...
                        <p className="task2-physics-desc">
