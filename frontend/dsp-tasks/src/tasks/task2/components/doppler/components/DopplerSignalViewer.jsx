...
const DopplerSignalViewer = ({ 
    ...
    return (
        <div className="task2-doppler-signal-viewer">
            {/* Audio element */}
            <audio 
                ref={audioRef} 
                src={audioUrl} 
            ...
            {/* Signal Canvas */}
            <div className="task2-signal-canvas-container">
                <canvas ref={canvasRef} className="task2-signal-canvas" />
            </div>

            {/* Playback Controls */}
            {showPlaybackControls && audioUrl && (
                <div className="task2-doppler-playback-controls">
                    <div className="task2-playback-main-controls">
                        <button 
                            className="task2-control-button task2-stop-button"
                            onClick={handleStop}
                            title="Stop"
                        >
                        ...
                        <button 
                            className="task2-control-button task2-play-pause-button"
                        ...
                        <div className="task2-time-display">
                    ...
                    {/* Timeline */}
                    <div 
                        className="task2-timeline-container"
                        onClick={handleTimelineClick}
                    >
                        <div className="task2-timeline">
                            <div 
                                className="task2-timeline-progress"
                    ...
                    {/* Volume and Download */}
                    <div className="task2-secondary-controls">
                        ...
                        {onDownload && isGeneratedAudio && (
                            <button 
                                className="task2-download-button"
                                onClick={onDownload}
            ...
            {/* Metadata Display */}
            {metadata && (
                <div className="task2-signal-metadata">
                    ...
                    <div className="task2-metadata-item">
                        ...
                        <span className="task2-metadata-value">{metadata.duration} s</span>
                    </div>
                </div>
            )}
        </div>
