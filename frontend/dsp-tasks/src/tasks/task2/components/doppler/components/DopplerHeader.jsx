...
export default function DopplerHeader({ 
    ...
    return (
        <>
            ...
            <div className='task2-doppler-header-wrapper'>
                <div className='task2-doppler-header-content'>
                    <h1 className='task2-doppler-header-title'>Doppler Shift Simulator</h1>
                    <p className='task2-doppler-header-description'>
                    ...
                    <div className='task2-doppler-header-features'>
