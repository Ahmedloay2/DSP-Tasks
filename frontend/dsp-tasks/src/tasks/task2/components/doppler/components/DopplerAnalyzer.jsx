...
const DopplerAnalyzer = ({ onAnalysisComplete, isLoading, setIsLoading, setError }) => {
    ...
    const handleAnalyze = async () => {
        ...
        try {
            ...
            const { MockDopplerService } = await import('../services/MockDopplerService');
            const result = await MockDopplerService.analyzeAudioFile(uploadedFile);
    ...
    return (
        <div className="task2-doppler-analyzer">
            ...
            <div className="task2-analyzer-content">
                ...
                <div className="task2-upload-section">
                    <div className="task2-upload-area">
                        <input
                            ...
                            id="audio-upload"
                        />
                        <label htmlFor="audio-upload" className="task2-upload-label">
                            <div className="task2-upload-icon">
                                <svg width="48" height="48" viewBox="0 0 24 24" fill="currentColor">
                                    <path d="M14,2H6A2,2 0 0,0 4,4V20A2,2 0 0,0 6,22H18A2,2 0 0,0 20,20V8L14,2M18,20H6V4H13V9H18V20Z"/>
                                </svg>
                            </div>
                            <div className="task2-upload-text">
                                <h4>Choose Audio File</h4>
                                <p>Click to browse or drag and drop</p>
                                <p className="task2-upload-formats">Supports MP3, WAV, AAC, OGG (max 10MB)</p>
                            </div>
                        </label>
                    </div>
                    ...
                    {uploadedFile && (
                        <div className="task2-file-info">
                            <div className="task2-file-details">
                                <div className="task2-file-icon">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                                        <path d="M14,2H6A2,2 0 0,0 4,4V20A2,2 0 0,0 6,22H18A2,2 0 0,0 20,20V8L14,2M18,20H6V4H13V9H18V20Z"/>
                                    </svg>
                                </div>
                                <div className="task2-file-meta">
                                    <div className="task2-file-name">{uploadedFile.name}</div>
                                    <div className="task2-file-size">{formatFileSize(uploadedFile.size)}</div>
                                    <div className="task2-file-type">{uploadedFile.type}</div>
                                </div>
                                <button
                                    className="task2-file-remove"
                                    onClick={clearFile}
                                    disabled={isLoading}
                ...
                {analysisResult && (
                    <div className="task2-analysis-results">
                        ...
                        <div className="task2-results-grid">
                            <div className="task2-result-card task2-primary">
                                <div className="task2-result-icon">🎵</div>
                                <div className="task2-result-content">
                                    <div className="task2-result-label">Source Frequency</div>
                                    <div className="task2-result-value">
                            ...
                            <div className="task2-result-card task2-primary">
                                <div className="task2-result-icon">🚗</div>
                                <div className="task2-result-content">
                                    <div className="task2-result-label">Source Velocity</div>
                                    <div className="task2-result-value">
                            ...
                            <div className="task2-result-card">
                                <div className="task2-result-content">
                                    <div className="task2-result-label">Confidence Score</div>
                                    <div className="task2-result-value">
                            ...
                            <div className="task2-result-card">
                                <div className="task2-result-content">
                                    <div className="task2-result-label">Duration</div>
                                    <div className="task2-result-value">
                        ...
                        <div className="task2-analysis-details">
                        ...
                        <div className="task2-velocity-interpretation">
                            <h5>🎯 Results Summary</h5>
                            <div className="task2-interpretation-content">
                                {analysisResult.analysis.estimatedSourceVelocity > 0 ? (
                                    <div className="task2-interpretation task2-approaching">
                                        <div className="task2-interpretation-icon">➡️</div>
                                        <div className="task2-interpretation-text">
                                    ...
                                    <div className="task2-interpretation task2-receding">
                                        <div className="task2-interpretation-icon">⬅️</div>
                                        <div className="task2-interpretation-text">
                                    ...
                                    <div className="task2-interpretation task2-stationary">
                                        <div className="task2-interpretation-icon">⭕</div>
                                        <div className="task2-interpretation-text">
                ...
                {/* Analysis Info */}
                <div className="task2-analysis-info">
                    <h4>ℹ️ How It Works</h4>
                    <div className="task2-info-grid">
                        <div className="task2-info-item">
