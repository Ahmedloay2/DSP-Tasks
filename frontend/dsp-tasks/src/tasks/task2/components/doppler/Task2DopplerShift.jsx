...
import RealDopplerService from './services/RealDopplerService';
import './Task2DopplerShift.css';

export default function Task2DopplerShift() {
    // Active tab state
    ...
    const handleDownloadAudio = useCallback(() => {
        try {
            ...
            RealDopplerService.downloadAudio(filename);
    ...
    useEffect(() => {
        return () => {
            RealDopplerService.clearSession();
        };
    }, []);

    return (
        <div className="task2-doppler-container">
            <Link to="/task1" className="task2-back-link">
                ← Back to Task 2 Home
            </Link>

            <div className="task2-doppler-header">
                <DopplerHeader />
            </div>

            {/* Tab Navigation */}
            <div className="task2-doppler-tabs">
                <div className="task2-tabs-container">
                    <button
                        className={`task2-tab-btn ${task2-activeTab === 'generate' ? 'active' : ''}`}
                    ...
                    <button
                        className={`task2-tab-btn ${task2-activeTab === 'analyze' ? 'active' : ''}`}
                    ...
                    <button
                        className={`task2-tab-btn ${task2-activeTab === 'detect' ? 'active' : ''}`}
            ...
            {ui.error && (
                <div className="task2-doppler-error">
            ...
            {ui.successMessage && (
                <div className="task2-doppler-success">
                    <div className="task2-success-message">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
            ...
            {/* Tab Content */}
            <div className="task2-doppler-tab-content">
                {activeTab === 'generate' && (
                    <div className="task2-doppler-generate-layout">
                        <div className="task2-generate-controls">
                            <DopplerGenerator
                        ...
                        {generatedAudio.audioUrl && (
                            <div className="task2-generate-results">
                                <div className="task2-results-header">
                                    <h3>🎵 Generated Audio</h3>
                                    <button
                                        className="task2-clear-btn"
                ...
                {activeTab === 'analyze' && (
                    <div className="task2-doppler-analyze-layout">
                        <div className="task2-analyze-controls">
                            <DopplerAnalyzer
                        ...
                        {analysisResults && (
                            <div className="task2-analyze-results">
                                <div className="task2-results-header">
                                ...
                                <div className="task2-analysis-summary">
                ...
                {activeTab === 'detect' && (
                    <div className="task2-doppler-detect-layout">
                        <DroneDetector
            ...
            {/* Loading Overlay */}
            {ui.isLoading && (
                <div className="task2-loading-overlay">
                    <div className="task2-loading-content">
                        <div className="task2-loading-spinner-large"></div>
                        <p>
                            {activeTab === 'generate' 
