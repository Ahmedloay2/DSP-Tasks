...
export default function SARHeader({ 
    ...
    return (
        <>
            ...
            <div className='task2-sar-header-wrapper'>
                <div className='task2-sar-header-content'>
                    <h1 className='task2-sar-header-title'>SAR Image Analysis</h1>
                    <p className='task2-sar-header-description'>
                    ...
                    <div className='task2-sar-header-features'>
