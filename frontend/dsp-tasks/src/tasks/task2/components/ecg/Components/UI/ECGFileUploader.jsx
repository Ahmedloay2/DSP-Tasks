...
export default function ECGFileUploader({ 
    ...
    return (
        <div className="task2-task1-ecg-upload-section">
            <form className='task2-task1-ecg-form' onSubmit={handleSubmit}>
                <div className='task2-task1-ecg-inputs-container'>
                    {/* Header File Input */}
                    <div className='task2-task1-ecg-input-group'>
                    ...
                    <div className='task2-task1-ecg-input-group'>
                        ...
                        {files.atr && (
                            <div className="task2-file-selected">
                                <span className="task2-file-name">{files.atr.name}</span>
                                <span className="task2-file-size">
                ...
                {/* Submit Button */}
                <button
                    className={`task2-task1-ecg-submit-btn ${uploadStatus}`}
                    type='submit'
                ...
                {uploadStatus === 'uploading' && (
                    <div className="task2-upload-progress">
                        ...
                        <span className="task2-progress-text">Processing ECG data...</span>
                    </div>
                )}
