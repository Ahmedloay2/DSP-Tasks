...
import MockDopplerApiService from './services/MockDopplerApiService';
...
export default function Task1DopplerShift() {
    ...
    const handleDownloadAudio = useCallback(() => {
        try {
            ...
            MockDopplerApiService.downloadAudio(filename);
    ...
    useEffect(() => {
        return () => {
            MockDopplerApiService.cleanup();
        };
    }, []);

    return (
        <>
            <section className='task1-doppler-header'>
                <h1 className='task1-doppler-header-main'>Welcome to our Doppler Shift Simulator</h1>
                <h4 className='task1-doppler-header-description'>What you can do here:</h4>
                <ul className='task1-doppler-header-list'>
                    <li className='task1-doppler-header-list-item'>Generate audio demonstrating the Doppler effect with custom parameters</li>
                    <li className='task1-doppler-header-list-item'>Analyze uploaded audio files to detect frequency shifts</li>
                    <li className='task1-doppler-header-list-item'>Interactive playback with download capabilities</li>
                    <li className='task1-doppler-header-list-item'>Real-time parameter visualization and physics explanation</li>
                </ul>
            </section>
