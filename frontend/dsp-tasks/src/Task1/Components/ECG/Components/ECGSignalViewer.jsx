...
const ECGSignalViewer = ({ 
  ...
  // Get currently visible subgraphs
  const visibleSubgraphs = visibleLeadsList.slice(clampedScrollPosition, clampedScrollPosition + MAX_VISIBLE_SUBGRAPHS);
